...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PlacesAutocomplete = function (_Component) {
	  ...
	  function PlacesAutocomplete(props) {
	    ...
	    _this.handleLocalAddressCallback = _this.handleLocalAddressCallback.bind(_this);
	  ...
	  _createClass(PlacesAutocomplete, [{
	    ...
	    value: function autocompleteCallback(predictions, status) {
	      ...
	      var currentAutocompleteItems = predictions.map(function (p, idx) {
	        return {
	      ...
	      if (this.state.localAddress != null) {
	        ...
	        var currentLocalAddress = Object.assign({}, this.state.localAddress, { active: highlightFirstSuggestion && predictions.length === 0 ? true : false, index: 0 });
	    ...
	    key: 'handleLocalAddressCallback',
	    value: function handleLocalAddressCallback(predictions) {
	      if (predictions != null) {
	        var p = predictions[0];
